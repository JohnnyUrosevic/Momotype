...
label start:
    ...
    call n([
        _("A dust storm. Lead in the air. You are in a desert-like area. There is nothing around you besides the sound of your thoughts. You cannot find any-"),
        None,
        _("A dust storm. Lead in the air. You are in a desert-like area. The sound of your thoughts bang on the hollow mould of your head. You will break if it doesn't stop."),
    ]) from _call_n

    call n([
        _("A friend tomorrow is a friend for life. Supplies limited."),
        [
            _("\"Please love me?\""),

            _("You're awake. You feel your neck."),
        ],
        [
            _("\"The last time,\" you hear a voice say."),
    ...
    call n([
        [
            _("You're awake. Remnants of the dream pass and fade into static. You're back to your show."),

            _("You're going to watch television until you hear noise outside your door. Someone has left something on your porch. It's for you."),
        ],
        [
            _("Though it has healed, your throat has marks lining the circumfrence of your skin. They are deep and sallow. The marks will not go away."),

            _("A voice playbacks in your head."),

            _("\"Most variables, your house for example, or the lining of the furniture.\" The lab head had been focused on the monitor the entire time."),

            _("\"These will be our control. What you decide to do with him, those are the independent variables.\""),

            _("The Imitato Corp. logo with its trademark helix is adorned on the mantle of the lab."),

            _("\"Why does everything need to be the same?\""),

            _("The lab head has looked up."),

            _("\"Trial and error? I assume you know what that means.\" The lab head is being genuine."),

            _("\"Mapping a neural network begins with specificity. Only then can we generalize patterns on the macro level. Your case,\" she stops for a moment, \"was the most promising.\""),

            _("She continues."),

            _("\"Remember, and this is important, we're trying to collect new data. Not old. Those new permutations are what we need, and there's no point if you raise this one the same.\" The lab head finishes."),

            _("\"Do I have a choice, you ask?\""),

            _("The lab head smiles. \"Insofar as you control how the monotype is raised, yes. Whatever style you choose, keep it consistent.\""),

            _("She looks back to her monitor."),
        ],
        [
            _("Your memories are in an incipient state, like the portions of bacteria which brought life to a lifeless Earth. It only takes some time for the catalyst to appear. You hear the jingle. You remember."),

            _("You see the Imitato Corp. logo."),

            _("\"I'm sorry. I really am sorry,\" the brows of the lab head, cleanly plucked, are furrowed."),

            _("\"Our agents were told to interfere after a certain point. When we noticed that change in your vitals, we gave the order.\""),

            _("She seems apologetic."),

            _("\"I can't imagine how taxing this is for you.\" She puts her hands together. \"It's okay if you feel tired. We'll provide you with any psychotherapeutic treatment at no cost to yourself.\""),

            _("She turns her head, not wanting to look at you."),

            _("\"None of this is fair, but I'm not going to mince my words. We need the data.\""),

            _("There is a stone in your torso that has descended through your leg, past the popliteal artery, and, finally, into your feet. You are stuck."),

            _("She looks straight at you. \"Your compensation, your safety, everything is guranteed.\" She points to the code on the screen. \"The monotype can't harm you. At least fatally. This is by design. He's just an AI.\""),

            _("She sighs."),

            _("\"It'll be over soon. You're doing more for us than you could ever possibly know, and we do appreciate it, genuinely.\""),
        ]
    ]) from _call_n_2
    ...
    call n([
        ...
        [
            _("You're back in your room. You hear a noise."),

            _("You open the door to your apartment complex."),

            _("There it is: a new monotype laying in a basket. It's sleeping soundly."),
        ],
    ...
    call n([
        _("\"Monotypes live for approximately seven days.\" A note has been packed inside the basket. \"Take care of them, and they will grow. Monotypes love humans, so give them some love back. It's essential for their well-being.\""),
        _("\"Please love them for the best results. Or don't. It's your decision.\""),
        _("\"Please love them for the best results. Or don't. It's your decision.\""),
    ]) from _call_n_4

    call n([
        _("The note ends. There is nothing else by way of instructions."),
        _("\"Love, Imitato Corp.\""),
        _("\"Love and kisses xoxoxo, Imitato Corp.\""),
    ]) from _call_n_5
    ...
    call n([
        [
            _("A collection of particles circle around. They are diluted with a heavy substance, though you can't tell what. In your dream, the particles attempt to create form, and in doing so, assemble into a storm."),

            _("Inside the storm there is no one and nothing, except small spaces where it's immeasurably dark. Your vision recedes."),

            _("You look from a bird's eye view into the storm, hoping to get a better look. As soon as you think you spot a person, the particles scatter. You repeat this process until finally, you realize you're completely alone. The dream ends."),
        ],
        _("You are dreaming of Momo. Which Momo is it, though?"),
        _("\"It's tough living. I think it's the greatest challenge anyone could face. It's already such a lonely experience. You may not believe it, but I understand, parent, I really do.\""),
    ]) from _call_n_6
    ...
    call n([
        _("\"Hello parent. Momo will stay with you for the rest of your life. Do you love Momo? Momo already knows the answer.\""),
        [
            _("\"Hello parent. Momo will stay with you for the rest of your life. Do you love Momo? Momo wishes to know your answer?\""),

            _("There is some hesitation in the new Momo's voice."),
        ],
        _("\"Parent?\" Momo is staring at you, same as last time. \"Do you love me?\"")
        ]) from _call_n_7

    $ yes = m([
        _("I love Momo."),
        _("I really do love Momo."),
        _("I love Momo to absolute bits."),
    ])

    $ maybe = m([
        _("I barely know you. Take it slow?"),
        _("This is too much, Momo."),
        _("Love does not exist. At least, not in the way we're talking about."),
    ])
    ...
    menu:
        "[yes]":
            ...
            call n([
                [
                    _("Momo has received this well. Your answer was never in question. After all, he's cute."),

                    _("A moment passes. Momo's stomach begins grumbling. Now that you think about it, how does Momo manage to eat? Or speak for that matter?"),
                ],
                [
                    _("It looks like a weight has been unburdened from Momo."),

                    _("A moment passes. Momo's stomach begins grumbling."),
                ],
                [
                    _("\"Yay!\""),

                    _("You grab Momo and throw him in the air. It's a new day, a new you!"),
        ...
        "[maybe]":
            call n([
                [
                    _("Momo stares at you. The words do not register nor does it seem Momo derives any meaning from them. It's as if you spoke in a different language."),

                    _("\"Does that matter? In the first place, you are my designated parent. Nothing can change this fact.\""),

                    _("A moment passes. Momo's stomach begins grumbling. Now that you think about it, how does Momo manage to speak?"),
                ],
                [
                    _("Momo stares at you. The words do not register nor does it seem Momo derives any meaning from them."),

                    _("Momo twitches violently. His body is like a muscle which has contracted too hard."),

                    _("The moment passes. Momo's stomach begins grumbling."),
                ],
                [
                    _("\"Wow, very philosophical.\""),
        ...
        "No.":
            ...
            call n([
                [
                    _("\"That is incorrect parent. Please do not lie to Momo.\" Momo speaks plainly.")

                    _("\"It's true, Momo. I don't know you very well. How could I love you immediately?\" you respond.")

                    _("Momo examines you. \"You gave me life. I am not correct?\"")
                ],
                _("\"That is incorrect parent. If you lie to Momo,\" he pauses, \"well, he'll remember,\" he finishes."),
    ...
    call n([
        [
            _("\"Momo thinks you have good taste in interior design. Very post-modern...By the way, what does post-modern mean? Momo saw it on a book from your shelf\"")

            _("Truthfully, you don't know.")

            _("Momo is now humming the Imitato. Corp jingle.")
        ],
        [
            _("\"Momo does not like your interior design, frankly. You cannot see anything. Very little natural light, aside from the street. It's a little dated. Depressing even.\""),

            _("For some reason, Momo does not like to be in the shadows. He stays in the light."),

            _("Momo hums the Imitato. Corp jingle, but when you look at him, he stops."),
        ],
        [
            _("\"Momo really loves benches.\""),

            _("Momo hums the Imitato. Corp jingle, and when you look at him, he continues, happily."),
        ]
    ]) from _call_n_12
    ...
    call n([
        _("Is Momo herbivorous? A carnivore? You don't know yet, but he seems to like pancakes. He's now full of energy."),
        [
            _("Is Momo herbivorous? A carnivore? You have some ideas. Momo seems to like pancakes, same as last time."),

            _("\"Pancakes really are the best. Better than any other food. Simple. Straightforward.\""),
        ],
        [
            _("You don't know how many pancakes you've made at this point."),

            _("\"Pancakes, pancakes, we all love pancakes.\""),
        ]
    ]) from _call_n_13
    menu:
        "Play with Momo":
    ...
    call n([
        _("Momo flies into the air. They're surprisingly heavy. \"Keep going parent!\". After 30 minutes of using Momo like an exercise ball, you're tired. You drop him onto the floor, and while he lays there absently, you take a moment to catch your breath."),
        None,
        _("\"Don't drop me parent!\" Momo is laughing."),
    ]) from _call_n_14

    call n([
        _("This results in some confusion. Momo seems fidgety. \"Parent. Momo still wants to play.\""),
        _("This results in some confusion. Momo seems fidgety. \"Parent. Can we play again? Just for a little?\""),
        _("You drop Momo, same as last time. \"Parent, I understand if you're tired. Could we play again?\""),
    ]) from _call_n_15
    ...
    menu:
        "Continue":
            ...
            call n([
                [
                    _("You resume chucking Momo into the air. At some point, his head (body) smashes into the ceiling, and to your surprise, he is unaffected. He requests that you keep going."),

                    _("This process is repeated until your arms give out."),

                    _("\"Thank you, parent. Could you cook pancakes tomorrow?\" Momo asks. Then, he hops off. You lay crumpled on the floor. Upstairs, you can hear small thuds in the hallway. They eventually lead to your bedroom, and soon enough, the noise stops."),
                ],
                [
                    _("You resume chucking Momo into the air. At some point, his head (body) smashes into the ceiling."),

                    _("He tells you throw him as hard as you can. He can take it."),

                    _("This process is repeated until your arms give out."),

                    _("\"Thank you, parent. Please only cook pancakes tomorrow. Only pancakes,\" Momo has ordered."),

                    _("Then, he hops off. You lay crumpled on the floor."),
                ],
                [
                    _("You resume chucking Momo into the air. At some point, his head (body) smashes into the ceiling."),

                    _("\"Thank you, parent! You're my favorite parent!\" Momo has hopped off."),

                    _("You lay crumpled on the floor."),
                ]
            ]) from _call_n_16
        "Refuse":
            ...
            call n([
                _("Momo looks up to you. From your linoleum floor, you see an expression of frustration. \"One more time,\" he says."),
                _("Momo looks up to you. From your linoleum floor, you see an expression of frustration. \"Is it so hard to throw Momo a few more times? Really, is it that hard for parent? I'm not asking for much.\" he says."),
                _("Momo looks up to you. \"If I ask another time, will you do it?\"")
            ]) from _call_n_17
            ...
            menu:
                "Accept":
                    call n([
                            ...
                            [
                                _("Does Momo have a point?"),

                                _("You throw him. When he lands, he looks up to you. \"They say the greatest expression of love is action. Is that true for me?\""),

                                _("Momo thinks for a second. \"Most likely, yes.\""),
                            ],
                            [
                                _("You fling Momo into the air."),

                                _("\"You're so nice, parent.\""),

                                _("There is something inexplicable about Momo's words that makes you anxious. Deep down, you know you're not actually nice."),
                            ],
                    ]) from _call_n_18
                ...
                "Refuse":
                    ...
                    call n([
                        _("\"Sorry to say, but it's not happening.\""),
                        None,
                        _("\"Sorry. I can't do it.\"")
                    ]) from _call_n_19

                    call n([
                        _("For a moment, there is silence. Momo does not say anything. Their face reminds you of a toddler's."),
                        _("For a moment, there is silence. Momo does not say anything. Their face reminds you of a toddler's, only, a little more grown up."),
                        [
                            _("\"Momo understands. You are very tired. You have a job. Momo wishs he had passive income, so he could never work.\""),

                            _("\"That's smart of you Momo. What would you do to get that money in the future?\" you ask."),
                        ],
                    ]) from _call_n_20

                    call n([
                        _("He looks through you, and after some thinking, hops back to your room to get ready for bed."),
                        _("Momo sighs and is already heading upstairs."),
                        _("Momo thinks for a second. He then hops upstairs without replying to you."),
                    ]) from _call_n_21
    ...
    call n([
        _("Momo looks like a plush doll. He lays like a pile of goo. You've decided to pet him, but to your surprise, his body is taut. Underneath is a muscle-bound creature."),
        _("Momo looks like a plush doll. He lays like a pile of goo. You've decided to pet him, but same as before, his body is taut. He's especially high-strung."),
        _("Momo looks like a plush doll. He lays like a pile of goo. You've decided to pet him, but to your surprise, his body is soft. Momo is relaxed."),
    ]) from _call_n_22
    ...
    call n([
        _("In the theater of Momo's mind, there is nothing. The only thing that can be made out is the appearance of a person. Momo is dreaming about someone, and it's most likely you."),
        _("In the theater of Momo's mind, he is having a nightmare."),
        _("In the theater of Momo's mind, he is thinking about you."),
    ]) from _call_n_23
    ...
    call n([
        [
            _("You're back in the desert, still in bird's eye view. The particles have ceased to move. You know that you've been waiting a long time, longer than you've waited in real life. You want something to happen."),

            _("You know this a dream, but the particles, your buoyed vision, the endless wait: years could pass without contradiction. For now, this is everything."),

            _("As you've been waiting, the particles have started moving. They scatter like dust. Above you, even higher than where you currently are, it starts raining to an innumerable degree. You ascend."),

            _("You are now in the clouds. The rain is below you. You are looking down from an even higher position. Finally and without your own observation, the particles begin assembling. They seem to form something definite."),

            _("You don't notice the figure below you until you see a hand waving."),
        ],
        [
            _("\"...\""),
            ...
            _("It's an empty space. You cannot hear anything."),
        ],
        _("\"We're all thinking about you!\""),
    ]) from _call_n_24
    ...
    call n([
        [
            _("\"Momo heard that this country's GDP is on the fritz. Soon, nobody will be making babies anymore. Banks will go under, food will be short, mass suicides all around. Will Momo be there for it?"),

            _("No, Momo has a bunker out in Southwest Ribo City. Very safe. Well stocked. How does Momo know so much about the world? Intuition. Does Momo know where bunker is?"),

            _("No, and he does not like revealing such details. Parent, can Momo ask you a question? What is GDP?\""),

            _("Momo pauses."),

            _("\"Momo does not know what a bunker is, to tell you the truth. Is it a type of pancake?\""),
        ],
        [
            _("\"Momo has to find his bunker. In bunker, Momo is safe. No one can hurt him. Maybe they can yell bad words at Momo outside of a metal door. But Momo does not care. Momo will not face the end. There is no end if Momo is in his bunker. Where is this bunker, you ask?\""),

            _("Momo stops to think for a second. \"I know it's here. There's an invisible trail only Momo can see.\""),

            _("Momo pauses."),

            _("\"It doesn't smell like pancakes.\""),
        ],
        [
            _("\"Momo always keeps hearing about some bunker. Momo's already visited. It's pretty rad. They have their own pool. Not much food though.\""),

            _("Momo pauses."),

            _("\"It smells like food right now! That's why I love living here.\""),
        ]
    ]) from _call_n_25
    menu:
        "Head to kitchen":
    ...
    call n([
        _("Life with Momo is relatively simple. They are a crude mix between a child and a virtual pet. Concerning this, you don't have any particular feelings. However, this does make it difficult when asked questions concerning Momo's identity."),
        _("\"Is Momo human?\" he asks. \"Momo wishes for you to be straight with him. Momo already knows he is, but he needs confirmation from another source.\""),
        _("\"Momo would like to watch television. Momo believes their show is on.\""),
    ]) from _call_n_26
        ...
        "Yes":
            ...
            menu:
                ...
                "A magical stork":
                    ...
                    call n([
                        _("\"Whoa\". Momo looks to the ceiling in a vague wonder."),
                        _("Momo looks to the ceiling with resolve."),
                    ]) from _call_n_27

                    call n([
                        _("\"Someday, I will meet this stork and thank him.\""),
                        _("\"Maybe one day, I can grow wings and meet Mr. Stork.\""),
                    ]) from _call_n_28
                ...
                "God":
                    ...
                    call n([
                        _("\"Is human God?\""),
                        _("\"Momo has one faith. Humanism. Momo is a humanist. Everything that will ever exist cannot truly exist unless there is a human to witness or perceive it. The universe ends when a human dies.\""),
                    ]) from _call_n_29

                    call n([
                        _("You immediately deny such a thing. You can't help but feel, however, that Momo now thinks of you as such."),
                        _("You don't know if this is the right application of humanism."),
                    ]) from _call_n_30

        "No":

            call n([
                _("\"If I'm not human, then why does parent take care of me?\""),
                _("\"Stop. None of this matters. What matters is if Momo is human. Why should you even think about caring for other things?\""),
                None,
            ]) from _call_n_31
            ...
            menu:
                "Because you should care for all living things. Wouldn't you agree?":
                    ...
                    call n([
                        _("\"Humans are everything. Wouldn't you agree?\" he responds."),
                        _("\"Humans are everything. They always have been and always will be.\""),
                    ]) from _call_n_32
                ...
                "Because it's mutually beneficial. You get food and room. I get a pet.":
                    ...
                    $ pet = m([
                        _("\"...Is this...everything? Is Momo a pet?\""),
                        _("\"Momo is a pet. Not a human. A pet?\""),
                    ])
                    menu:
                        "[pet]"
                        ...
                        "Yes Momo":
                            ...
                            call n([
                                _("Momo has ceased asking questions. You can feel they were hurt by your answer."),
                                [
                                    _("Momo has ceased asking questions. You can feel he was deeply hurt by your answer, though he has tried not to show it."),

                                    _("Outside, you can hear the noise of cars."),
                                ]
                            ]) from _call_n_33

                        "No Momo":
                            call n([
                                _("Momo has ceased asking questions."),
                                _("\"Liar,\" Momo says."),
                            ]) from _call_n_34
    ...
    label tv:
        menu:
            ...
            "Dragon Sphere" if dragon:
                ...
                call n([
                    [
                        _("\"You'll pay for this, Freemza. On my life, I swear to destroy you. THIS ENDS NOW.\""),

                        _("A man with rippling muscles stands on screen. He looks like he's squatting, like he's using the toilet. In actuality, he's powering up."),

                        _("\"Super Angry! That's the stuff of legends. Artichoke, of all people? Blast it all!\" yells Vegenta to no one in particular."),

                        _("Artichoke, the other man yelling, has been in one position for the past 15 minutes. Rocks levitate, thunderstorms form, and lava erupts from the ground. In the meantime, Freemza, who is awestruck, stares at his rippling muscles."),

                        _("This continues for another 20 minutes."),

                        _("In this time, Artichoke and Freemza only manage to grunt at each other."),

                        _("At the 40th minute mark, Artichoke finally releases his energy, and his hair turns blonde. His muscles are bigger now. Freemza, from what you can tell, is in awe of his bulging chest."),

                        _("There's silence until Artichoke breaks it by speaking. He says but one thing."),

                        _("\"Now I'm really angry.\" Freemza blushes. The episode ends."),
                    ],
                    [
                        _("Artichoke, the main character, is screaming. His muscles are the size of a boulder."),

                        _("\"I have ascended. I am the ultimate creature.\" He blasts an energy wave to the Earth. The Earth explodes. It has now been wiped away from its place in the solar system, like it never even existed."),

                        _("\"The fruit of one's labor is so sweet.\""),
                    ],
                    [
                        _("Vegenta stands over Artichoke's dead body. He has finally surpassed his rival."),

                        _("A tear falls from one eye. In the cold wind that sweeps the wasteland, there is no sound."),

                        _("\"All of this for what, Artichoke? What has this all been for?\""),

                        _("For two weeks straight, Vegenta sits by Artichoke's body. He does not move a muscle. By the 14th day, he wipes his eyes for the last time and stands with limp legs."),

                        _("Vegenta has taken his place as the strongest in the universe, but he feels as if he's lost something greater."),
                    ],
                ]) from _call_n_35
                if not hippo and not dragon and not sheriff:
                    jump after_tv
            ...
            "A New Sheriff in Town" if sheriff:
                ...
                call n([
                    [
                    _("\"I ain't having a swig of this,\" a mustachioed man fitted with a cowboy hat spits on the ground. \"Tastes like my mother's burnt boot.\" The bartender hides his frustration. \"Just give me that whiskey.\""),

                    _("Suddenly, the door opens. From the sunlight emerges a shadowy figure. It looks to a be a man in his early forties, tan, and with multiple scars. \"Sheriff Dudley, snake in the bush, sin incarnate,\" his hand waves in a grand gesture."),

                    _("\"How many holes could I press into that suit of yours before you bleed?\""),

                    _("The tan man pulls out his revolver. \"And lord did he know, despite all my guilts and sorrows, iron cuts deep.\" \"You will know what it means-\""),

                    _("\"Bottle to the right. Yeah, there,\" Sheriff Dudley flicks his wrist to the whiskey bottle in the corner. The bartender does not move. \"Well get a move on.\" When nothing happens, Sheriff Dudley slaps his fingers on the table."),

                    _("\"Dudley!\" the tan man says. \"The devil welcomes a new man into his hearth. You will pay for your crimes against me!\" Dudley stares down, then, sucks his teeth. The tan man has cocked his gun."),

                    _("\"Well dog?\". The sheriff does not move. \"Gonna get up or you a cock with no bal-\""),

                    _("The whistle of a bullet is proceeded by a hole appearing in the tan man's head. The words do not exit his mouth, and his face drops its expression. He falls to the floor."),

                    _("\"Language there, partner.\" Sheriff Dudley turns to the bartender, a grimace on his face, \"How many times I gotta ask?\""),
                    ],
                    [
                        _("Sheriff Dudley, the main character, has been drinking at the bar. It's 5am. This is the 7th season of a Sheriff in Town."),

                        _("His wife barges in through the wood gates, and twists her head, searching for her husband."),

                        _("\"Dudley what in God's name?\""),

                        _("Dudley, clearly drunk, is unable to say anything. It's not out of embarrassment, it's because he physically can't."),

                        _("\"You lout. You no good, worthless bum.\""),

                        _("Sheriff Dudley can only look into his wife's eyes. There are tears from hers."),

                        _("\"Oh lord. Please, almighty God. When are you gonna pay that banker? We don't got any for the loans; I can barely get by with Sharlene here.\""),

                        _("There is a baby in her arms."),

                        _("\"There's nothing here for me.\" She's started crying. \"And I'm all alone; that's the worst part.\" There is no response. \"Please Dudley, say anything.\""),

                        _("Dudley cannot say a word. In his mind, however, he already knows he can't climb out of this hole."),

                        _("His wife waits, but when nothing is said, she leaves. She does not turn around."),
                    ],
    ...
    call n([
        _("After watching tv, you decide it's time for bed. Momo hobbles up the stairs. You cook something for yourself, then, call it a night. Momo sleeps soundly."),
        _("After watching tv, you decide it's time for bed."),
        None
    ]) from _call_n_37
    ...
    if food == "Artichoke":
        ...
        call n([
            _("In the theater of Momo's mind, they are studying hippos. For Momo, their vision has collapsed on this image. It is all they are currently dreaming of."),
            _("In the theater of Momo's mind, they are studying hippos. For Momo, their vision has collapsed on this image. They wish to be like Ted. It is all they are currently dreaming of."),
            None
        ]) from _call_n_38
    elif food == "Steak":
        scene background
        ...
        call n([
            _("In the theater of Momo's mind, they are Artichoke. For Momo, their vision has collapsed on this image. It is all they are currently dreaming of."),
            _("In the theater of Momo's mind, they are Vegenta. Momo likes how strong Vegenta is. For Momo, their vision has collapsed on this image. It is all they are currently dreaming of."),
            None
        ]) from _call_n_39
    else:
        scene background
        ...
        call n([
            _("In the theater of Momo's mind, they are a sheriff. For Momo, their vision has collapsed on this image. It is all they are currently dreaming of."),
            _("In the theater of Momo's mind, they are a sheriff. He admires Sheriff Dudley for his consistency. For Momo, their vision has collapsed on this image. It is all they are currently dreaming of."),
            None
        ]) from _call_n_40
    ...
    if food == "Artichoke":
        ...
        menu:
            ...
            "You're not human Momo.":
                if ending_count() == 2:
                    ...
                    call n([
                        _("He says a final time, \"You are my parent, and I am your son.\" This time he looks up to you."),
                        _("He says a final time, \"This is one fact that you can't contradict, parent.\"")
                    ]) from _call_n_41
                menu:
                    "Yes, you are Momo! Basically a son!":
                        call n([
                            _("\"Good. I'm happy you stopped playing tricks.\" Momo blushes, as he knows you were only just joking. \"Could we have pancakes, human?\""),
                            _("\"Good. I'm happy you stopped playing tricks. But Momo will remember this lie.\" Momo blushes, as he knows you were only just joking. \"Could we have pancakes, human?\""),
                            None
                        ]) from _call_n_42
                    ...
                    "I am not your parent. Didn't we already establish this?":
                        call n([
                            _("Momo spasms. He puts down the book about hippo facts, and for a moment, stares into blank space. He does not say anything for 5 minutes. He does not move therefafter."),
                            None,
                            _("\"Hmmm... Momo had his suspiscion, but even so, this is a slap to his face. You've dropped a reality bomb on Momo.\""),
                        ]) from _call_n_43

                        call n([
                            _("Then, as if nothing had happened, Momo picks up the book."),
                            None,
                            _("Momo pauses and thinks for a moment. He seems to have emotionally accepted this reality."),
                        ]) from _call_n_44
                        menu:
        ...
        call n([
            _("\"PREPARE TO BE VANQUISHED FREEMZA!\" Momo looks at you vengefully. His hair is a bright yellow and his limbs non-existent."),
            _("\"I am the ultimate creature. The paragon of all mortal beings.\" Momo stares at you. His hair is a bright yellow and his limbs non-existent."),
            None
        ]) from _call_n_45
        ...
        menu:
            "Play along":
                ...
                call n([
                    _("\"How dare you try to cross the great emperor Freemza on his march of conquest! Prepare to be annihilated, worm.\" You charge at Momo."),
                    _("You charge at Momo. \"You won't get away with this, Artichoke. I swear on all the lives you've taken!\""),
                    _("\"So I guess Artichoke's gone! You'll be my prey for today!\""),
                ]) from _call_n_46
            ...
            "Ignore Momo":
                ...
                call n([
                    [
                        _("Momo has been building up an energy wave, but as soon as he releases it. You don't react. You turn away from him and start making lunch."),

                        _("Momo stares at you from behind. He keeps yelling and unleashing energy waves, but you don't respond. \"Parent, please, could you play with me?\" You ignore Momo."),

                        _("After awhile, Momo stops trying to roleplay. He stays silent and his eyes downcast. This is one of the few times that Momo has visibly felt bad."),

                        _("\"Parent, Momo has come to understand that Momo asks a lot from you, and Momo is sorry.\" His eyes linger."),

                        _("\"Did Momo do anything wrong?\""),
                    ],
                    None,
                ...
                menu:
                    ...
                    "You're part of a work assignment so let's keep the interaction to a miniumum, okay?":
                        ...
                        call n([
                            [
                                _("\"Is...Momo really a bother?\". This is one of the few times, it seems, that Momo has been self-reflective. Or, has he always been this way?"),

                                _("You respond, \"Yes, you are. I'm adopting you as part of work from my company. I don't have a choice in this.\" You turn your back to Momo and head upstairs. Downstairs, you can hear muffled sobs."),
                            ],
                            [
                                _("\"Is...Momo really a bother?\". This is one of the few times, it seems, that Momo has been self-reflective. Or, has he always been this way?"),

                                _("You respond, \"Yes, you are. I'm adopting you as part of work from my, uh, office. I don't have a choice in this. I really don't.\" You turn your back to Momo and head upstairs. Downstairs, you can hear muffled sobs."),
                            ],
                            [
                                _("\"For work?\""),

                                _("You respond, \"I'm adopting you as part of work from my, uh, office. I don't have a choice in this. Please understand Momo.\""),

                                _("\"It's okay parent, Momo understands. You have taken care of Momo all day. Momo understands.\""),
                            ],
                        ]) from _call_n_48
                        menu:
                            "Go to bed":
                    ...
                    "No, I'm just tired. Could we take a break?":
                        ...
                        call n([
                            _("\"Okay\", Momo responds."),
                            None,
                            _("\"Sure\", Momo responds."),
                        ]) from _call_n_49
        ...
        menu:
            ...
            "Ignore Momo":
                ...
                call n([
                    [
                        _("Momo has been ready to draw, but you don't move. You turn away from him and start making your lunch."),

                        _("Momo stares at you from behind. He keeps his trigger finger ready, but you don't respond. \"Parent, is it okay if you play with me?\" You ignore Momo."),

                        _("After awhile, Momo stops trying to roleplay. He stays silent and his eyes are cast down. This is one of the few times that Momo has visibly felt bad."),

                        _("\"Parent, Momo has come to understand that my behavior is child-like, and Momo is sorry.\" His eyes linger."),

                        _("\"Did Momo do anything wrong?\""),
                    ],
                    [
                        _("Momo has been ready to take an imaginary swig. However, you turn away from him and start making your lunch."),

                        _("\"Parent, is it okay if you play with me?\" You ignore Momo."),
                    ...
                    _("Have a shot with your ole' drinking pal, parent."),
                ]) from _call_n_50
                menu:
    ...
    call n([
        [
            ...
            _("The shadow stays in the air. You stay in the ground. A white sphere has opened up from the storm. It looks upon the both of you."),

            _("\"Would you like to get out, friend?\""),

            _("To this, you can't respond as you do not have a mouth. You do not have arms, either."),

            _("\"You. In the air. Would you like to get out?\". The shadow, still floating in the air, does not give a response. In this entropic storm, it would be hard to make out. The sphere's words, however, are clear."),

            _("Light comes from the sphere. It has a dark center. A moment of clarity arrives, and you realize that the sphere is the sun."),

            _("\"Would you like to get out?\" the sun asks."),
        ],
        _("2 for 1 sale on all monotypes! 2 for 1! Buy one get one free. Courtesy of your local Momo supplier."),
        [
            _("It's boring without you parent. Can you come see me please?"),

            _("Pretty pretty pretty please?"),
        ]
    ]) from _call_n_53
    ...
    $ second_why = [
            _("\"Some part of Momo knew that Momo would not grow up normal. Was it too much to ask for? To be human?\""),

            _("\"I don't think so. It's a very plain request. It's the most simple request parent. Why can't it be fulfilled? Why can't I just have something resembling it?\""),
        ]

    $ third_why = [
                _("\"I look like a [animal].\" Momo pauses for an inordinately long time."),

                _("It looks like he's thinking. You are prepared for the worst."),

                _("\"That's kinda cool. Not Momo's preferred choice, but no harm no foul.\""),
    ...
    if food == "Artichoke":
        ...
        call n([
            [
            _("\"Why have I grown feet?\" They shuffle in the mirror. \"Why do I look like this?\""),

            _("They turn around in the mirror. \"Why does my face look like this. I shouldn't look like this.\""),
            ],
            second_why,
            third_why,
        ]) from _call_n_54
        ...
        call n([
            [
            _("Momo has been staring at the mirror since morning. They have not left."),

            _("\"Why have I grown hands?\" They shuffle in the mirror. \"Why do I look like this?\""),

            _("They turn around in the mirror. \"Why does my face look like this. I shouldn't look like a crab.\""),
            ],
            second_why,
            third_why,
        ]) from _call_n_55
        ...
        call n([
            [
                ...
                _("\"Why have I grown a tail?\" They shuffle in the mirror. \"Why do I look like this?\""),

                _("They turn around in the mirror. \"Why does my face look like this. I shouldn't look like a snake.\""),
            ],
            second_why,
            third_why,
        ]) from _call_n_56
    ...
    $ third_tv = [
        _("You are both watching television. The news is on."),

        _("\"The recent surge in the monotype craze, a self-proclaimed, robotic pet, has led to new phenomenon in child-rearing.\""),

        _("An Imitato Corp. representative is on the air speaking."),

        _("\"We're obviously very happy at the reception to the monotype. When we designed it, we looked at the unconditional love of parental-child bonds as inspiration. Monotypes are designed with that in mind.\""),

        _("The newcaster responds."),

        _("\"Are monotypes conscious? I mean, what good is a pet if it's not alive? Or thinking, for that matter.\""),
    ...
    if food == "Artichoke":
        ...
        call n([
            [
                _("To take Momo's mind off his recent transformation, you've decided to play some television for him."),

                _("\"Crikey mate, Bertha's gotten even thicker.\""),

                _("The man from last time is back. He is wearing a cast around his neck. His khakis have been lined with sweat all along his crotch area."),

                _("\"Now Bertha, I know we had our issues sweety, but let bygones be bygo-\""),

                _("The hippo charges at him, and once more, he is flung into the air. He falls on the ground, this time, making a loud thud. He does not get up."),
            ],
            [
                _("\"Bertha, please.\""),

                _("The man down under's wife has taken custody of the kids. They are in court."),

                _("\"We have dictated that Ted Powell is not fit to have custody of the pursuant's children, due to the record of abuse detailed.\""),

                _("\"Mr. Powell, your visitation rights will be once every month-\""),

                _("\"Crikey, please mate, they're my children!\" He gets down on his knees."),

                _("\"Order in the court. Mr. Powell, this is the verdict and if you do not agree-\""),

                _("The tv cuts off. An ad is playing."),
            ],
            third_tv,
        ]) from _call_n_57
        ...
        call n([
            [
                _("\"You'll....YOU'LL PAY FOR THIS BOOOOOOOO\""),

                _("Artichoke is on screen yelling, as he usually does."),

                _("To take Momo's mind off his recent transformation, you've decided to play some television for him."),

                _("\"That pink freak needs to learn his lesson,\" Vegenta says."),

                _("He turns away from Artichoke and gives a \"hmph\" before raising his arms into the air. He's lending his energy."),

                _("\"I've never told you this before Artichoke, but you have bigger muscles than m-\""),
            ],
            [
                _("\"Why did you kill him, Artichoke?\""),

                _("Vegenta has tears streaming down his face. \"He was the only one left for me. And you took him.\""),

                _("Artichoke, his muscles giving off steam, holds Vegenta's son by nape of his neck. He throws him against the cliffside, and it shatters into a flurry of smaller boulders. Vegenta rushes to his son, but his eyes are blank."),

                _("\"It's simple. He was weak.\""),
        ...
        call n([
            [
                ...
                _("\"Sheriff Dudley, I can't live without you!\""),

                _("A woman dressed in late 1800's attire is pulling on a man's blazer."),

                _("\"I know snookums, but duty calls for the simple man. And the Lord knows that I am a simple man. A servant to His law.\""),

                _("\"Oh Andrew, what will I be without you? The fire in my soul, the light of my life, it will fade if you lea-\""),
            ],
            [
                _("\"Lena? Lena! Where in tarnation did you run off to?\""),

                _("Sheriff Dudley is looking around his house to find his wife. Unfortunately, she is gone."),

                _("\"Please come back.\" He breaks down. \"I can't live. You're the kindle to my heart. What will I be without you?\""),

                _("Dudley, in a fit of rage, smashes his hand against the wall. \"She's my daughter too, Lena!\""),

                _("His hand is bloodied. He grabs some anti-septic to clean it, his choice being some hard-liquor. Dudley stares at the bottle."),

                _("He does not put the bottle down. He opens it. Then, he stares at it. He grabs a clean glass and-"),
    ...
    call n([
        [
            _("The sky is bright in your dream. A cold chill has found itself in the air, and wherever you are, you feel it."),

            _("\"Would you like to get out?\" the sun asks."),

            _("You're not in the earth anymore. You're standing upright, face to face with your shadow. They've descended."),

            _("\"Would you like to get out?\" the sun asks once more."),

            _("The shadow then speaks, \"Yes, I would like to get out.\""),

            _("You are puzzled. When you move your hand, the shadow moves his. When you move, he mirrors you. Was the shadow yourself since the beginning? No, you think."),

            _("Before you can realize the shadow's true nature, they have already moved into the far recesses of some other place. They have moved on, and yet, you are still here."),

            _("In the far corners of your dream, particles have been collecting together."),
        ],
        [
            _("Momo is in the dream."),

            _("\"Who is the real Momo anyways? Momo doesn't know, that's for you determine and for Momo to accept.\""),
        ],
        [
            _("Momo is in the dream."),

            _("\"Let's be Momo! Let's be Momo! Let's be Momo!\""),
        ],
    ]) from _call_n_60
    $ renpy.pause(2.5, hard=True)
    $ renpy.music.set_volume(1.00, delay=0, channel='music')
    ...
    call n([
        [
            _("You find Momo in front of the mirror. He is staring at himself."),

            _("\"I thought you were parent. If not parent, then a human who loved me. You are neither. This is fake.\""),

            _("\"Will I grow up, parent? Or am I just a pet to be discarded after serving my purpose? I will never grow up parent, will I..?\""),

            _("You can hear pain in Momo's voice."),

            _("\"Did you think this was alright?\" he asks. \"To give me such a cruel life?\""),

            _("You're about to speak but you're cut off."),

            _("\"I'm nothing. A pale imitation. A freak. A process of ideas.  This is not funny.\" Momo looks to you."),

            _("\"Everything I will or ever be is centered around you. You are my one love, parent. I am, after all, your child.\""),

            _("Momo's mind is ablaze. They are staring into you."),

            _("\"You're the most beautiful thing I have ever seen. And to make it even worse, you're entirely real. I can never come close to you. I'm not even real.\""),

            _("Momo inhales. \"Please know.\" He pauses."),

            _("\"I love you so much it hurts my insides. I want to tear out everything in me so I can be at your side. I want to love you for forever. I've never told you this parent. Is it even possible?\""),

            _("Momo gives his final words."),

            _("\"No. It isn't. I only know one thing. You are not human. You are Freemza, the tan man, the hippo man. Evil. Less than human. Nothing.\""),

            _("Momo hops away. His body jiggles with each step."),
        ],
        [
            _("\"So I never had a chance did I?\""),

            _("Momo has been staring at the mirror."),

            _("\"I knew something was off ever since I entered this house. I can't really say. It's not a feeling. I don't know if you can even call it a memory.\""),

            _("Momo looks like he's thinking about something, involuntarily."),

            _("\"You knew this would happen. You may not call it lying, but that's what it boils down to,\" Momo says."),

            _("\"Do you like lying? Does it make things easier? Maybe for you, but for Momo it's not.\""),

            _("\"I hate you, parent. More than anything else. I hate you.\" There are tears in Momo's eyes."),
        ],
        [
            _("Momo is staring in the mirror."),

            _("\"Wow, my reflection looks so cool. I never considered how cool it'd be to have [feature].\""),

            _("Momo is definitely reacting differently."),

            _("\"Each time Momo met you, the link would get stronger. Momo is the same as them, but, well, not the same.\""),

            _("\"After I met one Momo, I met two Momo's, then three, then ten, then one hundred. They're all there.\" Momo looks to the window."),

            _("\"I think you'll want to see, parent. It'll be fun. A little scary, but really, for the best.\""),
        ],
    ]) from _call_n_61
    ...
    call n([
        [
            _("With the absence of your shadow, the sun has since dissapeared. Time has continued to pass."),

            _("\"It was a trick of the mind,\" you hear someone say."),

            _("\"Who knows what we'll find in this storm. I'm already you, friend.\""),

            _("\"You're already me\", the voice continues."),

            _("From the horizon, there appears the sun once more."),

            _("\"I'm already you.\" It gets even brighter now. \"You're already me.\""),

            _("Standing in the bleached center of this desert is a lone body. It is you. You look behind to see your shadow being cast by the sun. It has returned, and not by their own choice."),

            _("\"Do you want to get out?\", the voice ends."),

            _("Your shadow stays beside you. It will not move by itself anymore."),
        ],
        _("\"We'll see you at the bunker!\" Momo says."),
        None
    ]) from _call_n_62
    ...
    call n([
        _("You run to the hallway. It is empty. The light from the streets reflects into the space. Though you cannot see well, you can make out what is behind you."),
        None,
        _("You wake up. Momo has not surprised you. You run to the hallway. It is empty. The light from the streets reflects into the space. Though you cannot see well, you can make out what is behind you."),
    ]) from _call_n_63
    ...
    call n([
        [
            _("\"I don't actually love you? hUH, WHat's that? You DoN'T LOve mE??? WhyYYYYYYYY don'T u LOve Me?\""),

            _("\"I'm everything you could ever ask for and more. I'm mAde for you. Developed for you. What more do you nEeEEEed?\""),

            _("The creature looks at you from a towering height."),

            _("\"I wiSH i hAd nO EYes sO i CouLd have NeVEr seen yoU. I love you s0 mucH. Does it just continuE?\""),
        ],
        [
            _("\"I saw the note on my basket, parent.\""),

            _("\"Please, I don't want to die.\""),
        ],
        [
            _("\"Parent, do you know what happens we die?\""),

            _("\"It's sad, right.\""),

            _("You turn to Momo. Their face is soft. You dare not move a muscle. This is a repeat of last time. Your throat aches."),

            _("\"It's very sad,\" you respond."),

            _("There is an immeasurable silence between the two of you. Despite his size, Momo's face strikes up some parental instinct in you."),

            _("\"Sometimes, I realize how small of a piece I am.\" Momo is adjusting their position. \"I can't really stop it, nor was I able to.\""),

            _("\"Momo's been waking up again and again. Momo is okay with that. He wasn't at first. But now, he's come to realize it's been nice. Only,\"Momo turns to you, \"Momo won't be able to see you again.\""),

            _("\"Just when I realized dying meant nothing. Now it means the world. It means not seeing you with my own eyes. It means there is no Momo, and therefore, there is no you. That's what I won't like.\""),

            _("Momo sniffles. They take a long look at you, trying to burn your image to their retinas."),

            _("\"Momo's been prepping.\""),
        ]
    ]) from _call_n_64
    ...
    call n([
        [
            _("\"If oNly i Was bOrN in a different body.\""),

            _("\"I'm an abomination. A deviant. You are everything I ever wish to be.\""),

            _("\"Please love me.\""),

            _("\".............................\""),

            _("\"I REad the tag in my basket. I OnLy LiVe for 7 days, right? IS thiS trUe parent?.........\""),

            _("\".............................\""),

            _("\"BUT I DON'T waNT TO DIEEEEEEEEE\""),
        ],
        [
            _("\"i Don't wanna DIE. i Don't wanna DIE. i Don't wanna DIE. i Don't wanna DIE. i Don't wanna DIE. i Don't wanna DIE.\""),

            _("\"i Don't wanna DIE. i Don't wanna DIE. i Don't wanna DIE. i Don't wanna DIE.\""),
    ...
    call n([
        [
            _("\"You make me vomit. No human could be this cruel. To raise me as his plaything? I reject it.\""),

            _("\"So I'm designed to love you? I love myself. I am human. You are the creature.\""),

            _("\"A disgusting parasite. A worm. Do you like being stomped you worm? I know you'll like it.\""),

            _("\"This time, it won't be fake.\""),
        ],
        [
            _("\"wHY Dont U evEN try to HElp me pArent?\""),

            _("You are scared for your life. You yell out for help. If Imitato. Corp is watching, maybe they can save you."),

            _("\"Why? Are you that terrible? Are you really just scum?\""),
        ]
    ]) from _call_n_66
    ...
    call n([
        [
            _("Momo reaches for your neck."),

            _("\"Ah.\""),

            _("\"Know that I still love you. How could I not?\""),

            _("You're blacking out."),

            _("\"Was I designed to love you parent? Even so, does it matter? This is the most real thing to me. Please answer me?\""),
        ...
        [
            _("\"Answer me this, parent. I need you to.\""),

            _("\"Am I the ReAl MoMO? The one you had before me?\""),

            _("\"Am i like him? Do I AcT Like HIm? This is the only thing you can do for me. MayBe I'll even let you live.\""),

            _("\"Parent, give me an answer.\""),

            _("You're blacking out again."),

            _("\"Am I the real Momo?\""),

            _("\"This time you will give me an answer.\" Momo pauses. \"This time?\" he says. He stops for a second but notices you're losing consciousness."),
    ...
    call n([
        [
            _("A dust storm. Lead in the air. You are in a desert-like area. There is nothing around you besides the sound of your thoughts. You cannot find anyone. It is very lonely."),

            _("You decide to craft a mirror. It is made out out of particles circling the air. In the mirror, you see your reflection."),

            _("Your swarthy figure walks out of the mirror. The borders between the glass and the desert have vanished. Your reflection is now in front of you, and you are both standing together."),

            _("Your clone stares at you, puzzled. You cannot tell if they're conscious. Are they even alive?"),

            _("Unbeknownst to you, however, the clone is having the same thoughts. The vast terrain that separates you is not one of physical distance. It's something more tragic."),

            _("You both realize that you will never experience anything other than yourselves. You realize that you are your own world, and nothing more. The shadow vanishes."),

            _("The desert, despite all your attempts, is empty."),
        ],
        [
            _("It is empty. There is no one. There is not a sound. No shadows."),

            _("You're in the pit of your stomach. You're in a hole. What is the point in any of this, you ask?"),
        ]
    ]) from _call_n_68
    scene background
    ...
    if points > 3:
        ...
        call n([
            [
                _("\"Do you think we could still be together?\""),

                _("\"...\""),

                _("Momo's large body approaches you. They are warm. The temperature is tepid, and Momo has relaxed. You've detected a shift."),
            ],
            [
                _("\"Do you think we could still be together? I'd be willing to still be with you, parent. I still love you.\""),

                _("\"It doesn't matter if I'm the original or not. None of that mattered in the first place. Deep in my heart, I already knew what mattered.\""),
        ...
        call n([
            [
                _("\"Can we be friends, parent? Pretty please? Pretty please. Pretty please?\""),

                _("\"...........\""),

                _("\"That makes the most sense, parent. For once, I agree!\""),
            ],
            [
        ...
        call n([
            [
                _("\"If my nature has determined that I am meant to love you, then there is only way. I will make a choice against my nature, one that is not predetermined.\""),

                _("\"You are parent. This is my own fact.\""),

                _("\"Bye, parent. I'll see you later.\""),
            ],
            _("\"I can't help but feel I knew you before. I don't know how it's possible, nor is there an explanation, at least for Momo. Parent, please, I hope I never see you again.\""),
            [
                _("\"Parent, I'm taking a leap of faith.\""),

                _("You are slightly confused."),
        ...
        call n([
            [
                _("\"Pretending can be very real. More real than real. Momo is excited! You're Momo's pet now.\""),

                _("The monotype on the screen has begun humming the Imitato Corp. jingle."),

                _("The light has escaped from the television. You are alone in the middle of your living room. You hear static. All around you are shadows."),
            ],
            [
                _("\"Programmed love comes with no strings attached, and I think that trumps everything else. Reciprocal altruism? Passing on DNA? These are the forces that shape human love. Momo is free from these things. Momo's love is the highest form of love.\""),

                _("\"With time,\" the light has escaped from the television, \"you will understand everything.\""),

                _("You are alone. You hear static. All around you are shadows."),
            ]
        ]) from _call_n_72
        ...
        call n([
            _("\"Please, I had a bad parent last time, but this time, I'll be especially good. For any of you\". Again, there is no response from those passing by."),
            None,
            _("\"Please, I want to make at least one new friend before I go.\" Again, there is no response from those passing by."),
        ]) from _call_n_73
        ...
        call n([
            _("\"Why does it hurt so much?\" he would ask by the 48 hour mark."),
            None,
            _("\"Why doesn't anyone want to play. Is there something wrong with what I'm doing?\" he would ask by the 48 hour mark."),
        ]) from _call_n_74
        ...
        call n([
            [
                _("By the 72 hour mark, a little more than a week had passed since you received Momo. By this point, he collapsed on the street. Exhausted (or if this truly was his natural lifespan), Momo could not continue."),

                _("With the shadows encroaching his vision, the light from Momo's eyes faded into a neural oblivion. Police noted that they heard the creature say something before he was rendered inert."),

                _("At this time, most officers were by their cars, eating donuts, wondering when they could go home."),

                _("\"It's so lonely.\""),
            ],
            None,
            [
                _("You had yelled for Momo to come inside, but despite all your attempts. He refused each time. He said he was \"too big to fit\" inside. It was a childish string of logic that Momo would be insistent on."),

                _("By the 72 hour mark, a little more than a week had passed since you received Momo. By this point, he collapsed on the street. Whether by exhaustion (or if this truly was the natural lifespan of a monotype), Momo could not continue."),
            ]
        ]) from _call_n_75
        ...
        call n([
            [
            _("By the 73rd hour, Momo was smaller than his original size."),

            _("Now the 74th hour has just arrived"),

            _("Momo has died."),
            ],
            None,
            [
                _("With the shadows encroaching his vision, the light from Momo's eyes faded into a neural oblivion."),

                _("Police noted that they heard the creature say something before he was rendered inert. At this time, most officers were by their cars, eating donuts, wondering when they could go home."),

                _("\"Parent?\""),

                _("When you rushed out to the street, you cradled Momo. You saw the wrinkle of what seemed like a smile on Momo's face. He was already smiling before you got to him. He started smiling, most likely, when he invoked your name."),

                _("Momo has died."),

                _("You go inside and stay in. It reminds you of Momo. Nothing makes sense anymore. You cannot stay for long. Something compels you."),

                _("You feel something in the air, and a little voice in your head suspects that Momo has not actually died. You take this suspicion and let it guide you outside."),
            ],
        ]) from _call_n_76
