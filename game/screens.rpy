...
screen say(who, what):
    ...
    if what:
        on 'show' action SetVariable("menu_question", True)
    else:
        on 'show' action SetVariable("menu_question", False)
...
screen ctc(arg=None):
    if not config.skipping:
        on 'hide' action Play('sound', 'audio/momo_click.mp3')
...
style choice_button is default:
    properties gui.button_properties("choice_button")
    activate_sound "audio/momo_clicking.wav"
